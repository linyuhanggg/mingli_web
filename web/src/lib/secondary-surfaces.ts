...
const plannedTools = [
  {
    slug: "time-check",
    title: "寻时定盘",
    description: "围绕未知时辰生成十二个候选事实；事件匹配和候选排序暂未启用。",
    form: {
      fields: [
        { id: "time-check-range", label: "已知时间范围", type: "text", hint: "进入专用流程后由 Runtime 生成十二候选并标记范围命中。" },
        { id: "time-check-events", label: "可核对事件", type: "textarea", hint: "目前只记录事件条数；事件匹配、权重和排序尚未启用。" },
      ],
    },
  },
  {
...
export const publicContentSurfaces = {
  tools: {
    ...
    statusDescription: "本命音律、五行事实、同盘比较和寻时定盘已接入有界 Runtime 事实；解梦和姓名分析仍只展示范围，不能提交或生成结果。",
    entries: toolEntries,
  },
  library: {
    eyebrow: "知识内容",
