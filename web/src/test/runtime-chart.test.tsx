            ...
            signals: [
              {
                ...
                display_text:
                  "大六壬已提供来源绑定规则证据（LR-17）；当前仍不形成问事合参结论。",
                fact_refs: [
                  "fact:wenshi:fixture/calculated/liuren/dimension_facts",
                ],
              },
            ],
            convergence: [],
...
it("renders the source-bound Liuyao role adjudication without a line verdict", () => {
                  ...
                  candidates: [
                    {
                      ...
                      seasonal_adjudication: {
                        ...
                        source_ref: {
                          ...
                          rule_id: "ZR-05-05",
                          source_anchor:
                            "references/books/divination/zengshan-buyi/rules.md#ZR-05-05",
            ...
            role_adjudication: {
              ...
              specific_line_adjudication: {
                ...
                selection_source_ref: {
                  ...
                  rule_id: "HJC-R009",
                  source_anchor:
                    "references/books/divination/huangjin-ce/rules.md#HJC-R009",
                  verification_status: "verified",
  ...
  expect(
    screen.getByText("第4爻：旺（旺相带；ZR-05-05 已核验）"),
  ).toBeVisible();
  expect(
    screen.getByText(
...
it("renders every Runtime Qimen star when a palace has a duplicated star", () => {
        ...
        named_patterns: [
          {
            ...
            identity_adjudication: {
              ...
              source_ref: {
                ...
                rule_id: "QM-P13",
                source_anchor:
                  "references/books/san-shi/qimen-dunjia-tongzhi/rules.md#QM-P13",
                verification_status: "verified",
                binding_digest:
  ...
  expect(
    screen.getByText("QM-P13 · san-shi/qimen-dunjia-tongzhi"),
  ).toBeVisible();
...
it("renders relationship ViewModels as traceable cross-chart facts", () => {
  render(
    <RuntimeChart
      viewModel={{
        ...
        subjects: [
          {
            subject_ref: "profile-version:a",
            profile_version_id: "a",
            label: "甲方",
          },
          {
            subject_ref: "profile-version:b",
  ...
  expect(
    screen.queryByText(/fact:a\/calculated\/bazi\/four_pillars/),
  ).toBeNull();
...
it("renders Runtime Ziwei core facts without adding browser-side judgments", () => {
  ...
  expect(screen.getByRole("region", { name: "四化" })).toHaveTextContent(
    "廉贞",
  );
          ...
          source_conditioned_patterns: [
            {
              ...
              predicate_audit: [
                "/calendar_normalization/ganzhi/year:nonempty:()",
              ],
            },
          ],
          classical_bodies: [
...
it("renders time-check event evidence without turning an unmatched row into a verdict", () => {
    ...
    <RuntimeChart
      viewModel={{
        ...
        candidates: branches.map((hour_branch, index) => ({
          ...
          day_master: { stem: "甲" },
          calendar_normalization: {
            normalized_datetime: "2000-10-18T00:00:00+08:00",
          },
        })),
  ...
  expect(
    screen.getByText("存在合、会或三合支关系；事件领域对应十神角色"),
  ).toBeVisible();
...
it("renders internal Runtime provider ViewModels as bounded fact tables", () => {
        ...
        source_conditioned_patterns: [
          {
            ...
            applicability_adjudication: {
              ...
              source_ref: {
                ...
                rule_id: "LX-01-17",
                source_anchor:
                  "references/books/luming-nayin/li-xuzhong-mingshu/rules.md#LX-01-17",
                verification_status: "verified",
        ...
        board_predicates: [
          {
            ...
            identity_adjudication: {
              ...
              source_ref: {
                ...
                rule_id: "TY-P01",
                source_anchor:
                  "references/books/san-shi/taiyi-shenshu/rules.md#TY-P01",
                verification_status: "verified",
                binding_digest:
  ...
  rerender(
    <RuntimeChart
      viewModel={{
        ...
        compass: {
          status: "resolved",
          facing: { mountain: "午", trigram: "离", degrees: 180 },
        },
  ...
  expect(
    screen.queryByText("calculated_selected_school_facts_not_verdict"),
  ).toBeNull();
    ...
    <RuntimeChart
      viewModel={{
                  ...
                  source_refs: [
                    {
                      ...
                      rule_id: "MR-04-02",
                      source_anchor:
                        "references/fulltext/divination/meihua-yishu/fulltext.md#L875",
                      verification_status: "verified",
                      binding_digest:
                        "202662eb4c023883aab61febf3de3d7d42137740f31d50ba1a7ada25149db50f",
                    },
                  ],
                  unresolved_checks: [
                    "具体问题中的体用取义、领域例外与外应",
        ...
        public_labels: [
          ...
          { key: "spring", label: "春" },
          {
            key: "calculated_strength_not_verdict",
            label: "旺衰已计算，尚非断语",
          },
        ],
      }}
  ...
  render(
    <RuntimeChart
      viewModel={{
        ...
        public_labels: [{ key: "money", label: "求财" }],
      }}
    />,
  );
...
it("renders DaliurenBoard for daliuren-chart/v1 and fail-closes missing timing_candidates", () => {
  ...
  expect(
    screen.queryByRole("region", { name: "应期" }),
  ).not.toBeInTheDocument();
  expect(screen.queryByText("有界应期候选")).not.toBeInTheDocument();
});
