...
| metric | value |
|---|---:|
| normalized_source_lines | 1629 |
| structural_units_in_chapter_map | 138 |
| digest_status_done | 138 |
| digest_status_partial | 0 |
| digest_status_pending | 0 |
| digest_status_unavailable | 0 |
| quote_index_entries | 138 |

## 版本边界

作者与版本均有托名/通行本差异风险；当前 D2 ready 只表示本地维基文库通行本已完整建图。
