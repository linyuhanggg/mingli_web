...
- 生成时间（UTC）：2026-08-10T22:04:45+00:00
- 服务器：`iZuf67fkafnm3w0abdmz3mZ`（SSH 别名 `fateradar-prod`）
- 本机 main HEAD：`90c2a29`；服务器 current：`/opt/fateradar/releases/3cd39ed88fe642efa8b0a0eb3e543d189f0db538`
...
| S6-preview-bazi | preview bazi (career) | FAIL | input_ready / ['input_ready', 'prepared', 'delayed'] / delayed |
...
| S10-follow-up | follow-up (new version) | FAIL | no accepted base reading / True |
...
- 运行前：`{"available": true, "counts": {"accepted": 7, "delayed": 13, "terminal_stopped": 1}, "total": 21}`
- 运行后：`{"available": true, "counts": {"accepted": 7, "delayed": 17, "terminal_stopped": 1}, "total": 25}`
